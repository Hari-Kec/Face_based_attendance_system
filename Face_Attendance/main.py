...
def open_hostel_website():
    webbrowser.open("http://localhost:3005/")

root = tk.Tk()
root.title("Hostel Management System")

hostel_website_button = ttk.Button(root, text="HOSTEL WEBSITE", command=open_hostel_website)
hostel_website_button.pack(pady=20)
